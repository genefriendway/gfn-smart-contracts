...
def data_test(deployment, pcsp_deployment, const):
    ...
    gene_nft_token.mintBatchGNFT(
        [genetic_profile_owner1, genetic_profile_owner2],
...
def test_success__calculate_customer_reward__owner_make_txn(
    ...
    # Actions
    txn = pcsp_reward_contract.calculateCustomerReward(
        genenft_token_id1,
